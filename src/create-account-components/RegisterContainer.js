...
function RegisterContainer() {
  ...
  return (
    <div
      className="w-full md:w-1/2 bg-black text-white p-8 md:p-12"
      style={{
        display: "flex",
    ...
    >
      <div style={{ textAlign: "center" }}>
        ...
        >
          ...
          />
          <h2 className="select-none text-white text-center text-2xl mb-4 font-bold">
            Customer Sign up
          </h2>
        </div>
        <div className="mb-4">
          <label
            htmlFor="name"
            className="select-none block mb-2 text-left text-white font-bold"
          >
            Name
          </label>
          <input
            type="text"
            id="name"
            className="w-full  p-2 mb-4 bg-black border-b text-white focus:outline-none"
          ...
          <label
            ...
            className={`select-none block mb-2 text-left font-bold ${
              isEmailValid ? "text-white" : "text-red-500"
            }`}
          >
            Email
          </label>
          <input
            type="email"
            id="email"
            className={`w-full p-2 mb-4 bg-black border-b focus:outline-none ${
              isEmailValid ? "text-white" : "text-red-500"
            }`}
          ...
          <label
            htmlFor="password"
            className={`select-none block mb-2 text-left font-bold ${
              isPasswordValid ? "text-white" : "text-red-500"
            }`}
          >
            Password
          </label>
          ...
          <label
            ...
            className={`select-none block text-left mb-2 font-bold ${
              passwordsMatch ? "text-white" : "text-red-500"
            }`}
          >
            Confirm Password
          </label>
        ...
        <div>
          <label
            htmlFor="gender"
            className="select-none block  text-left mb-2 text-white font-bold"
          >
            Gender
          </label>
          <select
          ...
          <label
            htmlFor="phone"
            className={`select-none block mb-2 text-left font-bold ${
              hasNonNumericCharacters ? "text-red-500" : "text-white"
            }`}
          >
            Phone
          </label>
          ...
          <label
            htmlFor="country"
            className="select-none block text-left mb-2 mt-6 text-white font-bold"
          >
            Country
          </label>
          <select
