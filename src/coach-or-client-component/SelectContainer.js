...
function SelectContainer() {
  ...
  return (
    ...
    <div className="bg-white bg-opacity-50 backdrop-blur-lg p-8 m-4 mt-5 lg:mt-auto rounded-xl max-w-md w-full sm:w-1/2 flex flex-col justify-center items-center">
